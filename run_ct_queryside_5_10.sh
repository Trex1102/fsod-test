...
for shot in 5 10; do
    echo "=== CT query-side ${shot}-shot seed0 ==="

    python3 tools/create_config.py --dataset voc --config_root configs/voc \
        --shot ${shot} --seed 0 --setting fsod --split 1

    CFG=configs/voc/novelMethods/counterfactual_transport/defrcn_fsod_r101_novel1_${shot}shot_seed0_ct_queryside.yaml
    ...
    python3 main.py --num-gpus 1 --eval-only \
        ...
        OUTPUT_DIR checkpoints/voc/voc_ct_queryside/split1/${shot}shot_seed0 \
        TEST.PCB_MODELPATH .pretrain_weights/ImageNetPretrained/torchvision/resnet101-5d3b4d8f.pth \
        2>&1 | tee /tmp/ct_queryside_${shot}shot.log
