...
# ----- 9b2) PCB-FMA with full-image DINO patch RoI pooling ----- #
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH = CN()
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.ENABLE = False
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.FM_MODEL_NAME = "dinov2_vitb14"
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.FM_MODEL_PATH = ""
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.FM_FEAT_DIM = 768
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.IMAGE_SIZE = 518
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.CROP_SIZE = 224
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.PATCH_SIZE = 14
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.BATCH_SIZE = 32
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.DET_WEIGHT = 0.4
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.FM_WEIGHT = 0.6
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.USE_ORIGINAL_PCB = False
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.ORIGINAL_PCB_WEIGHT = 0.0
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.FM_ONLY = True
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.RUN_INNER_FIRST = False
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.FEATURE_MODE = "patch"  # patch, hybrid
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.POOL_MODE = "average"  # average, roi_align, center_weighted, max, attention
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.CROP_CLS_WEIGHT = 0.5
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.ATTENTION_TEMPERATURE = 0.2
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.TEMPERATURE = 0.1
_CC.NOVEL_METHODS.PCB_FMA_FULLIMG_PATCH.COMPETITIVE_MODE = "softmax"
...
_CC.NOVEL_METHODS.COUNTERFACTUAL_TRANSPORT.SEMANTIC_FILTER_THRESHOLD = 0.70  # cosine sim threshold: ring patches above this are removed (co-occurrence filter)
_CC.NOVEL_METHODS.COUNTERFACTUAL_TRANSPORT.MAX_FG_PATCHES = 512      # cap per-class fg bank size; 0 = unlimited

# ----- 12) PCB-FMA-Ring (FMA CLS + Ring Background Rejection) ----- #
# Combines augmented DINOv2 CLS prototype similarity (FMA signal) with a
# standalone ring transport background-rejection score.  A single DINOv2
# backbone returns both CLS and patch tokens; two batched passes per image.
# No fg patch bank needed — ring_score = sigmoid(bg_cost / ring_temperature).
_CC.NOVEL_METHODS.PCB_FMA_RING = CN()
_CC.NOVEL_METHODS.PCB_FMA_RING.ENABLE = False
_CC.NOVEL_METHODS.PCB_FMA_RING.FM_MODEL_NAME = "dinov2_vitb14"
_CC.NOVEL_METHODS.PCB_FMA_RING.FM_MODEL_PATH = ""
_CC.NOVEL_METHODS.PCB_FMA_RING.FM_FEAT_DIM = 768
_CC.NOVEL_METHODS.PCB_FMA_RING.ROI_SIZE = 224
_CC.NOVEL_METHODS.PCB_FMA_RING.BATCH_SIZE = 32
_CC.NOVEL_METHODS.PCB_FMA_RING.DET_WEIGHT = 0.3          # detector score weight
_CC.NOVEL_METHODS.PCB_FMA_RING.FMA_WEIGHT = 0.5           # DINOv2 CLS fg signal weight
_CC.NOVEL_METHODS.PCB_FMA_RING.RING_WEIGHT = 0.2          # ring bg-transport weight
_CC.NOVEL_METHODS.PCB_FMA_RING.RING_SCALE = 2.0           # box expansion factor for bg ring
_CC.NOVEL_METHODS.PCB_FMA_RING.RING_TEMPERATURE = 0.3     # sigmoid temperature for bg_cost
_CC.NOVEL_METHODS.PCB_FMA_RING.FMA_TEMPERATURE = 0.1      # softmax temperature for CLS sim
# Support augmentation (same as pcb_fma_enhanced)
_CC.NOVEL_METHODS.PCB_FMA_RING.AUG_FLIP = True
_CC.NOVEL_METHODS.PCB_FMA_RING.AUG_MULTICROP = True
_CC.NOVEL_METHODS.PCB_FMA_RING.AUG_MULTICROP_SCALES = [0.8, 0.9]
_CC.NOVEL_METHODS.PCB_FMA_RING.AUG_MULTICROP_NUM = 2
